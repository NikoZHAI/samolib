...
class GOMORS(SamplingMixin, LocalSearchMixin, SurrogateEAMixin, Population):
    ...
    def __init__(self, problem=None, dim=None, n_objs=None, size=32,
                 ...
                 max_eval=400, verbose=True, *args, **kwargs):
    ...
    def config_sampling(self, methods='default', sizes='default',
        ...
        **kwargs : Optional
        ...
        self._adaptive_sampling_config = {'m': _methods, 's': _sizes,
                                          'r': _sample_rates, 'c': _candidates}
    ...
    def sample_for_expensive_evals(self, config=None):
        ...
        """
        _c = self._adaptive_sampling_config if config == None else config

        candidates = []
        for _m, _s, _r, _p in zip(_c['m'], _c['s'], _c['r'], _c['c']):
    ...
    def run(self, params_ea=None, params_surrogate=None, theo=None):
        ...
        # Calculate initial hypervolume metrics
...
@MetaFramework
class MOPRISM(SamplingMixin, LocalSearchMixin, SurrogateEAMixin, Population):
    """ MORPRISM framework
    """

    def __init__(self, problem=None, dim=None, n_objs=None, size=100,
                 fitness_fun=_no_fit_fun, bounds=[], reference=[],
                 selection_fun=_no_selection_fun,
                 mutation_fun=gaussian_mutator,
                 crossover_fun=random_crossover,
                 revolution=True,
        ...
        self.local_search_ = local_search
    ...
    def run(self, params_ea=None, params_surrogate=None, theo=None):
        ...
        while not self.stop():
            ...
            if self.revolution:
                if self.progressive_revolution(self.no_improvement_step_tol,
