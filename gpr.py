...
class GaussianProcessRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(self, X, y):
        ...
        if self.optimizer is not None and self.kernel_.n_dims > 0:
            ...
            def obj_func_grad(theta, eval_gradient=True):
                if eval_gradient:
            ...
            # For heuristic optimizers
            def obj_func_ga(theta):
                return -self.log_marginal_likelihood(theta)

            if self.optimizer == 'fmin_l_bfgs_b':
                obj_func = obj_func_grad
            else:
                obj_func = obj_func_ga
    ...
    def predict(self, X, return_std=False, return_cov=False):
        ...
        y_std : array, shape = (n_samples,), optional
            Standard deviation of predictive distributiofmin_l_bfgs_bn at query points.
