...
class MLPSurrogate(BaseMultilayerPerceptron, RegressorMixin):
    """Multi-layer Perceptron regressor.
    ...
    def __init__(self, hidden_layer_sizes=(100,), activation="relu",
                 ...
                 nesterovs_momentum=True, early_stopping=False,
                 validation_fraction=0.1, beta_1=0.9, beta_2=0.999,
                 epsilon=1e-8, no_improvement_tol=2):

        sup = super(MLPSurrogate, self)
        sup.__init__(hidden_layer_sizes=hidden_layer_sizes,
                     activation=activation, solver=solver, alpha=alpha,
                     batch_size=batch_size, learning_rate=learning_rate,
                     learning_rate_init=learning_rate_init, power_t=power_t,
        ...
        self.no_improvement_tol = 2 if no_improvement_tol <= 2 else no_improvement_tol
    ...
    def _fit_stochastic(self, X, y, activations, deltas, coef_grads,
        ...
        try:
            ...
            for it in range(self.max_iter):
                ...
                if self._no_improvement_count > self.no_improvement_tol:
                    # not better than last two iterations by tol.
                    # stop or decrease learning rate
                    if early_stopping:
                        msg = ("Validation score did not improve more than "
