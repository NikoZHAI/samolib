...
# -*- coding: utf-8 -*-
"""
Benchmarking MOPRISM-raw, MOPRISM-10 and MOPRISM-20 with ZDT functions
...
def main():
    ...
    if not os.path.exists(directory+'seeds.txt'):
        seeds = np.random.randint(0, int(2**32-1), size=len(PROBLEM)*len(sample_size), dtype='u4')
