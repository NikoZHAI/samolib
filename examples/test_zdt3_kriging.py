...
from benchmarks import load_theo, zdt3
from _utils import gaussian_mutator, find_duplication, random_crossover
...
theo = load_theo('./ZDT/ZDT3.pf').as_matrix()
...
pop.config_surrogate(typ='kriging', params=params_surrogate, n_porcess=2)
pop.config_gap_opt(at='least_crowded', radius=0.05, size=2*POP_SIZE,
...
ax.scatter(x, y, c='royalblue', s=2.5, label="ANN Assisted NSGA-II")
...
n_dups = find_duplication(pop.sampled_archive).__len__()
