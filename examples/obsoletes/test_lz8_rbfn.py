...
from pySOT.kernels import CubicKernel, TPSKernel
...
pop = GOMORS(problem=PROBLEM, dim=DIMENSION, size=POP_SIZE, n_objs=N_OBJS,
             ...
             max_eval=MAX_EVAL, revolution=False)
...
pop.config_gap_opt(at='least_crowded', radius=0.1, size=POP_SIZE,
                   max_generation=MAX_GENERATION/2, selection_fun=None,
...
ax.text(ax.get_xlim()[1]-0.1, 0.9, 'LZ-8',
