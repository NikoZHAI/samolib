...
from ea import NSGA2, MOEAD
from benchmarks import LZ2
...
pop = GOMORS(problem=PROBLEM, dim=DIMENSION, size=POP_SIZE, n_objs=N_OBJS,
             ...
             max_eval=MAX_EVAL, revolution=1)
...
pop.config_surrogate(typ='ANN', params=params_surrogate, n_process=2)
pop.config_gap_opt(at='least_crowded', radius=0.1, size=POP_SIZE,
                   ...
                   crossover_fun=nsga_crossover, trial_method='lhs',
...
ax.text(ax.get_xlim()[1]-0.1, 0.9, 'LZ-2',
