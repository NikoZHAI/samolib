...
from benchmarks import load_theo, zdt2
from _utils import gaussian_mutator, nsga_crossover, find_duplication, random_crossover
...
theo = load_theo('./ZDT/ZDT2.pf').as_matrix()
